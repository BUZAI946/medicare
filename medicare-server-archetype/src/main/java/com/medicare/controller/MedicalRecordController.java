...
public class MedicalRecordController {
    ...
    public Result<List<MedicalRecordVO>> list(
        ...
        return Result.ok(medicalRecordService.findMedicalRecordVOList(patientId, registrationId));
    }
    ...
    public Result<MedicalRecordVO> detail(@PathVariable Long id) {
        return Result.ok(medicalRecordService.findMedicalRecordVOById(id));
    }
    ...
    public Result<MedicalRecordVO> getByRegistration(@PathVariable Long registrationId) {
        return Result.ok(medicalRecordService.findByRegistrationId(registrationId));
    }
