...
| 项目 | 技术栈 | 默认端口 | 描述 |
|------|--------|----------|------|
| **medicare-server** | Spring Boot 3.2.5 + JPA + MySQL | 8080 | 后端 REST API 服务 |
...
# 导入用户账号（admin/doctor/pharmacist）
...
| admin2 | admin123 | admin | 备用管理员 |
| doctor1 | doctor123 | doctor | 医生账号 |
| pharmacist1 | pharmacist123 | pharmacist | 药房药师 |
